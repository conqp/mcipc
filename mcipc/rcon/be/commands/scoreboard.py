...
class ObjectivesProxy(CommandProxy):
    ...
    def setdisplay(
        self, location: Location, objective: str, order: Optional[Order] = None
    ) -> str:
        """Sets a display."""
...
class PlayersProxy(CommandProxy):
    ...
    def random(
        self, player: str, objective: str, min: int, max: Optional[int] = None
    ) -> str:
    ...
    def operation(
        ...
        return self._run(
            "operation", target_name, target_objective, operation, selector, objective
        )
